...
## Lab 2-1: Tasks 1,Tasks 2, Tasks 3
# Task 1
...
<iframe src="https://public.tableau.com/views/Lab2_200/Task3?:showVizHome=no&:embed=true" width="100%" height="500"></iframe>

# Discussion
## Compare the difference in the distribution between the boroughs
There are five box-plots in this figure for five different boroughs.Staten Island has the highest trash production per person(71.75-80.20). In the box-plots, the lower whisker of Staten Island is larger than upper whisker of the other four boroughs. Queens has the widest range of trash production per person (45.04-69.47), Staten Island has the narrowest range of trash production per person.Manhattan disctrict 11 has the lowest trash production per person(38.67). Staten Island disctrict 3 has the highest trash production per person(80.20).
